...
function CompareMetricRow({ label }: { label: string }) {
  return (
    <div className="interactive-surface flex items-center justify-between rounded-[10px] border border-white/8 bg-white/[0.02] px-4 py-3 hover:border-white/14 hover:bg-white/[0.04]">
